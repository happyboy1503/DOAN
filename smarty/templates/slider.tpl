    	...
    	<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
			    <div class="item active">
			    	<img src="public\images\slider\1.jpg" alt="First slide">
                    <!-- Static Header -->
			    ...
			    <div class="item">
			    	<img src="public\images\slider\2.jpg" alt="Second slide">
			    	<!-- Static Header -->
                    <div class="header-text hidden-xs">
                        <div class="col-md-12 text-center">
                            <h2>
			    ...
			    <div class="item">
			    	<img src="public\images\slider\3.jpg" alt="Third slide">
			    	<!-- Static Header -->
                    <div class="header-text hidden-xs">
                        <div class="col-md-12 text-center">
                            <h2>
